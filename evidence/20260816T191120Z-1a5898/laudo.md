...
**sha256** `39789b1046040ee58bdacd33d561e5620cd0d077efda059f477235f35d751871`
...
- 5 campo(s) analisado(s)
- 0 classificado(s) — 0 PII, 0 sensivel
- por nivel: -
- 5 sem classificacao
...
| `cliente` | — | **sem classificacao** | — | — | — | campo sem termo no glossario (lacuna de F2) — classificar exige decisao humana |
| `data_pedido` | — | **sem classificacao** | — | — | — | campo sem termo no glossario (lacuna de F2) — classificar exige decisao humana |
| `entregas` | — | **sem classificacao** | — | — | — | campo sem termo no glossario (lacuna de F2) — classificar exige decisao humana |
...
5 item(ns), sob o pedido `8c80fae2672176a1`. Enquanto houver pendencia aqui, o campo correspondente **nao** recebe classificacao no contrato: o harness nao escreve "nao sei" num contrato de dados.

| Tipo | Campo | Detalhe |
|---|---|---|
| `lacuna` | `_id` | campo sem termo no glossario — segue sem classificacao no contrato ate decisao humana |
| `lacuna` | `cliente` | campo sem termo no glossario — segue sem classificacao no contrato ate decisao humana |
| `lacuna` | `data_pedido` | campo sem termo no glossario — segue sem classificacao no contrato ate decisao humana |
| `lacuna` | `entregas` | campo sem termo no glossario — segue sem classificacao no contrato ate decisao humana |
