...
// `Outcome` e `Exit` vem de `laudo`, e nao daqui: o desfecho de uma etapa e o
// codigo de saida sao do produto, e o que este crate possui e a **decisao** do
// que fazer com eles. Os dois imports desenham a fronteira melhor que qualquer
// comentario — se um dia `laudo` precisar de `Phase`, a linha nao existe.
use harness::flow::{HaltReason, PHASES, Phase, Transition, decide};
use laudo::exit::Exit;
