...
use laudo::persist::write_atomic;
use serde::{Deserialize, Serialize};
use std::fs;
use std::path::Path;

/// Reexportado de `laudo::persist`: o formato e o mesmo dos arquivos do gate,
/// e dois numeros independentes seriam duas coisas para manter.
pub use laudo::persist::SCHEMA_VERSION;
